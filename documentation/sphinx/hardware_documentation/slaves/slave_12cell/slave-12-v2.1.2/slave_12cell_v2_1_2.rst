...
.. _HW_SLAVE_12CELL_V2_1_2:

==================================
Slave 12-Cell ``v2.1.2 to v2.1.5``
==================================
...
.. important::
   ...
   The following description only applies for the 12-cell |BMS-Slave| hardware versions ``2.1.2`` to ``2.1.5``.
