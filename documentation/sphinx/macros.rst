...
.. |hw-version-interface| replace:: ``1.9.4``
.. |hw-version-12-slave| replace:: ``2.1.7``
.. |hw-version-18-slave| replace:: ``1.1.5``
...
.. -----------------------------------------------
.. |LTC-old| replace:: LTC6804-1
.. |LTC| replace:: LTC6811-1
.. |LTC-18| replace:: LTC6813-1
...
.. -----------------------------------------------
.. |mod_bms| replace:: ``bms`` module
.. |mod_sys| replace:: ``sys`` module
.. |mod_io| replace:: ``io`` module
.. |mod_contactor| replace:: ``contactor`` module
.. |mod_interlock| replace:: ``interlock`` module
...
.. |mod_nvmh| replace:: ``nvramhandler`` module
.. |mod_algo| replace:: ``algorithm`` module
.. |mod_adc| replace:: ``adc`` module
.. |mod_dma| replace:: ``dma`` module
.. |mod_foxmath| replace:: ``foxmath`` module
.. |mod_hwinfo| replace:: ``hwinfo`` module
.. |mod_vic| replace:: ``vic`` module
.. |mod_watchdog| replace:: ``watchdog`` module
.. |installer archive| replace:: ``foxconda-3.0.3-Windows-x86_64.exe``
